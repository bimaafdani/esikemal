	...
	<div class="col-md-10" style="padding:0px">
		<div class="content">		
			...
			if(isset($_POST['save'])){
				...
				$tujuan_surat = aman($_POST['tujuan_surat']);
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select name="tujuan_surat" class="form-control"  required>
							<?php
							$l_sifat	= array('Master Admin','Kepala','Kasubbag TU','Kasi PENDIS','Kasi BIMAS','Kasi P_Haji&Umrah','Kasi P_Syariah','Analis Kepegawaian','Pengawas Pendidikan','Perencana','Staff');
