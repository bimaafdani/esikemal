...
?>
 ...
 <div class="col-md-10" style="min-height:600px">
         ...
         <div class="col-md-12" style="padding:10px; padding-left:0;padding-right:0;">
            <a href="?submit_suratkeluar" class="btn btn-success" >Catat Surat Keluar</a>
         </div>
            <center>
                 ...
                 $sql = mysqli_query($koneksi, "SELECT * FROM surat_keluar");
                    while ($row = mysqli_fetch_array($sql)){
                     ...
                     <tr>
                        ...
                        <td>'.$row['tgl_surat'].'</td>
                        <td>'.$row['tgl_kirim'].'</td>
                        <td> <a href="surat_keluar/'.$row['file'].'"target = "_blank">'.$row['file'].' </a>
                        </td>
                        <td> 
                        ...
                        <a href="hapus.php?del_SK=delete&idsurat='.$row['idsurat'].'" title="Hapus Data" onclick="return confirm(\'Yakin?\')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                          </td>
                    </tr>
                    ';
                   }
