    ...
    <!-- Isi Tabel atau content-->
     <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-primary">
			...
			<?php
			$level  =  $_SESSION['id']; 
      $sql = mysqli_query($koneksi, "SELECT * FROM t_user WHERE id='$level'");
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($koneksi, "UPDATE t_user SET nama='$nama', nip='$nip', email='$email', level='$level' WHERE id='$level'") or die(mysqli_error());
				if($update){
