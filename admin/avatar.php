...
<body>
	...
	<div class="container">
		<div class="content">
			...
			<hr />
			<p>Upload Foto untuk ID: <b><?php echo $_GET['id']; ?></b></p>
			<?php
			$id = $_GET['id'];
			...
			if(isset($_FILES['fileToUpload'])){
				...
				if ($uploadOk == 0) {
					...
					if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $file)) {
						$up = mysqli_query($koneksi, "UPDATE t_user SET foto='$new_id' WHERE id='$id'");
						if($up){
							header("Location: avatar.php?id=".$id."&sukses=ya");
						}
					} else {
						echo '<div class="alert alert-danger">File gagal di upload.</div>';
					}
			...
			<div class="col-md-6 col-md-offset-3 text-center">
				<img class="img-responsive center-block" src="surat_masuk/<?php echo $row['foto']; ?>" width="150"><br />
