  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
<div id="content">
    <form method="post" action="laporanpembelian.php" target="_blank"></br>
	  <table>
	    <tr>
	      <th for ="tgl_awal">DARI TANGGAL &nbsp;&nbsp;&nbsp;&nbsp;</th>
	      <td><div id="datetimepicker" class="input-append date">	
		  <input class="form-control" type="text" id="tgl_awal" name="tgl_awal" required/>
		  <span class="add-on">
		  <i class="icon-calendar"></i>
		</span></div></td>
       <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	      <th scope="row" for ="tgl_akhir">SAMPAI DENGAN TANGGAL &nbsp;&nbsp;&nbsp;&nbsp;</th>
			<td><div id="datetimepicker" class="input-append date">	
		  <input class="form-control" type="text" id="tgl_akhir" name="tgl_akhir" required />
		   <span class="add-on">
		  <i class="icon-calendar"></i>
		</span></div>
		  </td>
          <td>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-primary"> Tampil</button></td></tr>
      </table>
