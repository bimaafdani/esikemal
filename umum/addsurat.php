        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
                <a href="submit_suratmasuk.php" class="btn btn-success" >Tambah Surat Masuk</a>
            ...
            <table class="table table-bordered">
              ...
              <?php
               ...
               $inputan = $_POST['inputan'];
                  if($inputan==""){
                  $sql = mysqli_query($koneksi, "SELECT * FROM surat_masuk WHERE YEAR(tgl_diterima)='2021' ORDER BY no_agenda DESC");
                  }elseif ($inputan!=""){
                    $sql = mysqli_query($koneksi, "SELECT * FROM surat_masuk WHERE perihal LIKE '%$inputan%'");
                  }
                }
                else {
                  $sql = mysqli_query($koneksi, "SELECT * FROM surat_masuk WHERE YEAR(tgl_diterima)='2017' ORDER BY no_agenda DESC");
                  }
                  $cek = mysqli_num_rows($sql);
                    ...
                    <?php
                     ...
                     <tr>
                        ...
                        <td>'.$row['perihal'].'</td>
                        <td><center>'.$row['asal'].'</td>
                        <td><center> <a href="../surat_masuk/'.$row['file'].'"target = "_blank"><span class="glyphicon glyphicon-paperclip" aria-hidden="true"></span> </a></td>
                        <td width=12%><center>
                        ...
                        <a href="teruskan.php?terus=terus&idsurat='.$row['idsurat'].'" title="Teruskan"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span></a>
                          </td>
                    </tr>
                    ';
                    $i++;
