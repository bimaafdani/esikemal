   ...
   <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-primary">
			...
			if(isset($_POST['add'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM t_klas WHERE kd_klas='$kd_klas'");
				if(mysqli_num_rows($cek) == 0){
					
				$insert = mysqli_query($koneksi, "INSERT INTO t_klas (kd_klas, nama_klas)
				VALUES('$kd_klas', '$nama_klas')") or die(mysqli_error());
					if($insert){
						...
						echo '<div class="alert alert-danger">Kode Klasifikasi Sudah Ada, Coba Yang Lain.</div>';
					} 
			}
			...
			<form class="form-horizontal" method="post" enctype='multipart/form-data'>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label">Kode Klasifikasi</label>
					<div class="col-sm-2">
						<input type="text" name="kd_klas" class="form-control" placeholder="KD0xx" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<textarea name="nama_klas" class="form-control" placeholder="Nama Klasifikasi" required></textarea>
				</div>
				</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<a href="klasifikasi.php" class="btn btn-danger">BATAL</a>
					</div>
				</div>
			</form>
		</div> <!-- /.box-primary -->
