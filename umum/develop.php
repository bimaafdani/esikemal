...
<div class="wrapper">
  ...
  <div class="col-md-10" style="padding:0px">
		<div class="content">		
			<marquee onmouseover="this.stop()" onmouseout="this.start()" scrollamount="20" direction="left" > 
				<h2 width="100%" height="100" align="center">MENU INI SEDANG DALAM PROSES PEMBUATAN</h2>
				</marquee> 
				
				<center> <img src="../image/develop.jpg"> </center>
