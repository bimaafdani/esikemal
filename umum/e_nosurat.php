        ...
        <div class="box box-primary">
            ...
            if(mysqli_num_rows($sql) == 0){
              ...
              if (isset($_POST['pick'])) {
                  ...
                  $no_dinas = ($row['no_dinas']);
                  $update= mysqli_query($koneksi, "UPDATE t_nomor SET nama='$nama', perihal='$perihal',kode_surat='$kode_surat',tgl_surat='$tgl_surat',tujuan_kirim='$tujuan_kirim' WHERE id = '$id'") or die ("Tidak Bisa Menggunakan Tanda Petik satu (')");
              if ($update){
                echo "<script>
                  swal({ 
                  title:'Data Surat Untuk Nomor ($no_dinas) Berhasil Dirubah',
                  type : 'success',
                  },
                  function(){
