   ...
   <section>   
    <div class="row">
		...
		<div class="content">			
			...
			<a href="e_suratmasuk.php?idsurat=<?php echo $row['idsurat']; ?>" class="btn btn-primary">Edit Data</a>
			<a href="teruskan.php?terus=terus&idsurat=<?php echo $row['idsurat'];?>" class="btn btn-success">Teruskan</a>
			<a href="hapus.php?del_SM=delete&idsurat=<?php echo $row['idsurat']; ?>" class="btn btn-danger" onclick="return confirm('Yakin?')">Hapus Data</a>
		</div>
	</div>
          </div>
          <!-- /.box -->
