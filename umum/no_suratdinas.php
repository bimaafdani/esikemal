    ...
    ?>
      <form action="" class="form-horizontal" method="post" enctype='multipart/form-data'>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
              <input type="date" name="tgl_surat" id="start_date" class="form-control" required>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <a href="rekapnodinas.php">Cetak Rekap</a>
          </div>
        </div>
        </form>  
             </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <table id="lookup" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                               <?php
                                    $query = mysqli_query($koneksi,'SELECT id, tgl_ambil, no_dinas, nama, kode_surat, perihal, tgl_surat, tujuan_kirim FROM t_nomor WHERE no_dinas >=1 ORDER BY no_dinas ASC');
                                    while ($data = mysqli_fetch_assoc($query)) {
                                    ?>
                                  
                                    <tr>
                                        <td><?php echo date('d/m/Y',strtotime($data['tgl_ambil']));?></td>
                                        <td width=2%><?php echo $data['no_dinas']; ?></td>
