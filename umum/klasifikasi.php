        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <a href="add_klasifikasi.php" class="btn btn-success" >Tambah Klasifikasi Surat</a>
            </div>
            ...
            <table class="table table-bordered">
                <tr>
                  ...
                  <th class="active"><center>Kode Surat</th>
                  <th class="active"><center>Kategori</th>
                  <th class="active"><center>Tindakan</th>
               </tr> 
              
              <?php
                
                 $sql = mysqli_query($koneksi, "SELECT * FROM t_klas");
                  //pagination config start
                    $rpp = 13; // jumlah record per halaman
                  ...
                  ?>
                    ...
                    <?php
                     ...
                     <tr>
                        ...
                        <td><center> '.$row['kd_klas'].'</td>                        
                        <td><center> '.$row['nama_klas'].'</td> 
                        <td><center> 
                        <a href="e_klasifikasi.php?kd_klas='.$row['kd_klas'].'" title="Rubah Data"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                        <a href="hapus.php?del_kat=delete&kd_klas='.$row['kd_klas'].'" title="Hapus Data" onclick="return confirm(\'Yakin?\')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                          </td>
                    </tr>
                    ';
                    $i++;
