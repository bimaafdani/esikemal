...
class FPDF_AutoWrapTable extends FPDF {
    ...
    public function rptDetailData () {
        ...
        $left = $this->GetX();
        $this->Cell(120, $h, 'Tgl. Ambil', 1, 0, 'C',true);
        $this->Cell(80, $h, 'No. Surat', 1, 0, 'C',true);
        $this->Cell(110, $h, 'Pengolah', 1, 0, 'C',true);
        $this->Cell(80, $h, 'Kode Surat', 1, 0, 'C',true);
        $this->Cell(240, $h, 'Perihal', 1, 0, 'C',true);
        $this->Cell(100, $h, 'Tgl. Surat', 1, 0, 'C',true);
        $this->Cell(130, $h, 'Tujuan Kirim', 1, 1, 'C',true);
        //$this->Ln(20);
 
        $this->SetFont('Arial','',12);
        $this->SetWidths(array(120,80,110,80,240,100,130));
...
$data = array();
$query = "SELECT tgl_ambil, no_dinas, nama, kode_surat, perihal, tgl_surat, tujuan_kirim FROM t_nomor WHERE no_dinas >=1 ORDER BY no_dinas ASC";
