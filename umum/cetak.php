...
<table style="width: 767px; height: 1200px; margin-left: auto; margin-right: auto;" border="1" cellspacing="1" cellpadding="1">
	<tbody>
		...
		<tr style="height: 35px;">
			<td style="height: 35px; width: 339px;">
				<p>Diterima Tangal &nbsp; &nbsp; &nbsp; : <?php echo date('d/m/Y',strtotime($row['tgl_terima']));?></p>
			</td>
			<td style="height: 35px; width: 412px;" colspan="2">
				<p>&nbsp;</p>
			</td>
		...
		<tr style="height: 35px;">
			<td style="height: 35px; width: 751px;" colspan="2">
				<p><span style="text-decoration: underline;">DISPOSISI KASUBBAG TATA USAHA/ KASI/ PENYELENGGARA :</span></p>
				<p>Kepada :&nbsp;<?php echo $row['penerima_tu']; ?></p>
				<p>Petunjuk : <?php echo $row['disposisi_tu']; ?> </p>
			</td>
		</tr>
		<tr style="height: 7px;">
