   ...
   <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-primary">
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($koneksi, "UPDATE t_kasubtu SET catatan='$catatan' WHERE idsurat='$idsurat'") or die(mysqli_error());
				if($update){
					echo "<script>
                  swal({ 
                  title:'Berhasil, Silahkan Teruskan Ke Kepala',
                  type : 'success',
                },
                function(){
			...
			<form class="form-horizontal" action="" method="post">
			    ...
			    <div class="form-group">
					...
					<div class="col-sm-4">
					<textarea name="catatan" class="form-control" placeholder="Tambah Catatan" required></textarea>
					</div>
				</div>
				</div>
				<div class="form-group">
            ...
            <input type="button" class="btn btn-warning" value="KEMBALI" onclick="javascript:history.go(-1)" >
