            ...
            <table class="table table-bordered">
              ...
              <?php
                if(isset($_POST['cari'])){
                  ...
                  if($inputan==""){
                  $sql = mysqli_query($koneksi, "SELECT * FROM t_kasubtu ORDER BY idsurat DESC");
                  }elseif ($inputan!=""){
                  $sql = mysqli_query($koneksi, "SELECT * FROM t_kasubtu WHERE perihal LIKE '%$inputan%'");
                  }
                }
                else {
                  $sql = mysqli_query($koneksi, "SELECT * FROM t_kasubtu ORDER BY idsurat DESC");
                  ...
                  $cek = mysqli_num_rows($sql);
                    ...
                    $reload = "suratmasuk.php?pagination=true";
                  ...
                  ?>
                     ...
                     <tr>
                        ...
                        <td><b>'.$row['perihal'].'</td>
                        <td><b>'.$row['asal'].'</td>
                        <td><b><a href="../surat_masuk/'.$row['file'].'"target = "_blank">File</td>
                        <td width=9%><b><center>
                    ...
                    ';}
                     ...
                     <tr>
                        ...
                        <td>'.$row['perihal'].'</td>
                        <td>'.$row['asal'].'</td>
                        <td><a href="../surat_masuk/'.$row['file'].'"target = "_blank">File</td>
                        <td><center>
                        <a href="l_suratmasuk.php?idsurat='.$row['idsurat'].'" title="Lihat Detail">Detail</a>
                     </td>  
                    </tr>
