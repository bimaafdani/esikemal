     ...
     <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-primary">
			...
			if(isset($_POST['save'])){
				...
				if($update){
					echo "<script>alert('Data Surat Berhasil Dirubah');window.location=history.go(-2)</script>";
				}else{
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<textarea name="perihal" class="form-control" placeholder="Edit Perihal Surat" required> <?php echo $row['perihal'];?> 
						</textarea>
				</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<a href="suratmasuk.php" class="btn btn-warning">BATAL</a>
					</div>
				</div>
			</form>
		</div>
