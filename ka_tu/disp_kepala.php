           ...
           <div class="box-header">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered">
                  ...
                  <th class="active" ><center>Nomor Surat</th>
                  <th class="active"><center>Perihal</th>
                  <th class="active"><center>Asal</th>
                  <th class="active"><center>Petunjuk</th>                  
                  <th class="active"><center>File Surat</th>                  
                ...
                <?php
                  ...
                  if($inputan==""){
                 $sql = mysqli_query($koneksi, "SELECT * FROM t_kepala where penerima like '%$level%'");
                  }elseif ($inputan!=""){
                  $sql = mysqli_query($koneksi, "SELECT * FROM t_kepala WHERE perihal LIKE '%$inputan%'");
                  }
                }
                else {
                 $sql = mysqli_query($koneksi, "SELECT * FROM t_kepala where penerima like '%$level%' ORDER BY idsurat DESC");
                  }
                  $cek = mysqli_num_rows($sql);
                   ...
                   //pagination config start
                    ...
                    $reload = "addsurat.php?pagination=true";
                ...
                ?>
                   ...
                   <?php
                     ...
                     <tr>
                        ...
                        <td><b>'.$row['no_surat'].'</td>
                        <td><b>'.$row['perihal'].'</td>
                        <td><b>'.$row['asal'].'</td>
                        <td><b>'.$row['petunjuk'].'</td>                    
                        <td><b><a href="../surat_masuk/'.$row['file'].'"target = "_blank">'.$row['file'].'</td>
                        <td><b><center>
                        <a href="l_dispkepala.php?idsurat='.$row['idsurat'].'" title="Lihat Detail"><span class="glyphicon glyphicon-list" aria-hidden="true"></span></a>
                        <a href="disposisi.php?terus=terus&idsurat='.$row['idsurat'].'" title="Disposisi"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></a>
                      </center></td>  
                    </tr>
                    ';}
                    else {
