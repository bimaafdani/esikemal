   ...
   <section>   
    <div class="row">
		...
		<div class="content">			
			...
			$unread = mysqli_query($koneksi, "UPDATE t_kepala SET baca='Y' WHERE idsurat='$idsurat'");
			
			$sql = mysqli_query($koneksi, "SELECT * FROM t_kepala, t_disp_tu where t_kepala.idsurat= t_disp_tu.idsurat and t_kepala.idsurat = '$idsurat'");
			...
			<table class="table table-striped">
				...
				<tr>
					<th>Isi Disposisi Kasubbag TU</th>
					<td><?php echo $row['disposisi_tu']; ?></td>
				</tr>

				<tr>
					<th>Isi Disposisi Kepala</th>
					<td><?php echo $row['isi_disposisi']; ?></td>
				</tr>
				
			</table>
			
			<a href="disp_kepala.php" class="btn btn-warning"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span></a>
			<a href="disposisi.php?terus=terus&idsurat=<?php echo $row['idsurat']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Disposisikan Ke</a>
	</div>
	</div>
	</div>
          <!-- /.box -->
