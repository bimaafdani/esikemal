...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h4>
        Surat Disposisi dari Kassubbag TU
      </h4>
      <ol class="breadcrumb">
          ...
          <div class="box">
            ...
            <table class="table table-bordered">
              ...
              <?php
                  ...
                  if($inputan==""){
                 $sql = mysqli_query($koneksi, "SELECT * FROM t_disp_tu WHERE penerima_tu LIKE '%$level%' ORDER BY idsurat DESC");
                  }elseif ($inputan!=""){
                  $sql = mysqli_query($koneksi, "SELECT * FROM t_disp_tu WHERE perihal LIKE '%$inputan%'");
                  }
                }
                else {
                 $sql = mysqli_query($koneksi, "SELECT * FROM t_disp_tu WHERE penerima_tu LIKE '%$level%' ORDER BY idsurat DESC");
                  ...
                  $cek = mysqli_num_rows($sql);
                    ...
                    $reload = "disp_tu.php?pagination=true";
                  ...
                  <?php
                    while(($count<$rpp) && ($i<$tcount)) {
                     ...
                     <tr>
                        ...
                        <td>'.$row['asal'].'</td>
                        <td>'.$row['petunjuk'].'</td>                    
                        <td width=1%><a href="../surat_masuk/'.$row['file'].'"target = "_blank"><span class="glyphicon glyphicon-paperclip" aria-hidden="true"></span> </td>
                        <td width=5%><center>
                        <a href="l_disptu.php?idsurat='.$row['idsurat'].'" title="Lihat Detail"><span class="glyphicon glyphicon-list" aria-hidden="true"></span></a>
                        <a href="cetak.php?idsurat='.$row['idsurat'].'" title="Cetak"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a>
                      </center></td>  
                    </tr>
                    ';
                    $i++;
