          ...
          <div class="box-header">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <?php
                  ...
                  if($inputan==""){
                 $sql = mysqli_query($koneksi, "SELECT * FROM t_kepala where penerima_staff LIKE '%$level%'");
                  }elseif ($inputan!=""){
                  $sql = mysqli_query($koneksi, "SELECT * FROM t_kepala WHERE perihal LIKE '%$inputan%'");
                  }
                }
                else {
                 $sql = mysqli_query($koneksi, "SELECT * FROM t_kepala where penerima_staff LIKE '%$level%' ORDER BY idsurat DESC");
                  }
                  $cek = mysqli_num_rows($sql);
                   ...
                   //pagination config start
                    ...
                    $reload = "surat_disp.php?pagination=true";
                  ...
                  <?php
                     ...
                     <tr>
                        ...
                        <td><center>
                        <a href="l_suratmasuk.php?idsurat='.$row['idsurat'].'" title="Lihat Detail">Detail</a>
                      </center></td>  
                    </tr>
                    ';
                    $i++;
