      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
		  ...
		  <?php
			...
			$jumlah_record=mysqli_query($koneksi, "SELECT * from t_kepala where penerima_staff like '%$session%'");
            ...
            <a href="surat_disp.php" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
