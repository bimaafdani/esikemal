   ...
   <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-primary">
			...
			if(isset($_POST['ganti'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM t_user WHERE level='$level' AND password='$password'");
				if(mysqli_num_rows($cek) == 0){
					...
					if($password1 == $password2){
						if(strlen($password1) >= 6){
							$pass = md5($password1);
							$update = mysqli_query($koneksi, "UPDATE t_user SET password='$pass' WHERE level='$level'");
							if($update){
							...
							echo '<div class="alert alert-danger">Panjang karakter Password minimal 6 karakter.</div>';
						}
					}else{
