                                ...
                                <div class="content">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <th>Catatan Kasi/ Penyelenggara</th>
                                            <td>:
                                                <?php echo $row[ 'disposisi_staff']; ?>
                                            </td>
                                        </tr>
                                    </table>
                                    <a href="surat_disp.php" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Kembali</a>
                                    <a href="cetak.php?idsurat=<?php echo $row['idsurat'];?>" class="btn btn-success"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Cetak</a>
                                </div>
                            </div>
                        </div>
                        <!-- /.box -->
