...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Nomor Surat Keputusan (SK) Kegiatan
      </h1>
      <ol class="breadcrumb">
                    ...
                    <div class="modal-body">
                      <table id="lookup" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                               <?php
                                    $level  =  $_SESSION['nama'];
                                    $query = mysqli_query($koneksi,"SELECT id, tgl_ambil, no_sk, nama, kode_surat, perihal, tgl_surat, tujuan_kirim FROM t_nomor WHERE no_sk>='1' AND nama='$level' ");
