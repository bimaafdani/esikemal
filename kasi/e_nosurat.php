        ...
        <div class="box box-primary">
            ...
            if(mysqli_num_rows($sql) == 0){
              ...
              if (isset($_POST['pick'])) {
                  ...
                  $update= mysqli_query($koneksi, "UPDATE t_nomor SET perihal='$perihal',kode_surat='$kode_surat',tgl_surat='$tgl_surat',tujuan_kirim='$tujuan_kirim' WHERE id = '$id'") or die (mysqli_error());
              if ($update){
                echo "<script>
                  swal({ 
