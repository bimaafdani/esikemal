    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
        Rincian Data Disposisi Dari Kepala
      </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Kementerian Agama Kota Lhokseumawe</a>
                    </li>
                        ...
                        <div class="box">
                            <div class="col-md-10" style="padding:0px">
                                <div class="content">
                                    ...
                                    }else{ $row=mysqli_fetch_assoc($sql); 
                                        }
                                    } 
                                    ?>
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <th>Tanggal Surat</th>
                                            <td>:
                                                <?php echo date( 'd/m/Y',strtotime($row[ 'tgl_surat']));?> </td>
                                        </tr>
                                        <tr>
                                            <th>Tanggal Diterima</th>
                                            <td>:
                                                <?php echo date( 'd/m/Y',strtotime($row[ 'tgl_diterima']));?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Lampiran</th>
                                        ...
                                        <tr>
						                    <?php 
						                    	if(($_SESSION['level'] == "Analis Kepegawaian") || ($_SESSION['level']=="Bagian Keuangan")){ 
						                    	echo '
												<th>Catatan Kassubag TU</th>
												<td>:'.$row['disposisi_tu']. ' </td>
												'; } 
											?>
                                        </tr>
                                    ...
                                    <a href="surat_disp.php" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Kembali</a>
                                    <a href="disposisi.php?idsurat=<?php echo $row['idsurat'];?>" class="btn btn-success"><span class="glyphicon glyphicon-send" aria-hidden="true"></span> Disposisi Ke</a>
                                    <a href="cetak.php?idsurat=<?php echo $row['idsurat'];?>" class="btn btn-primary"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Cetak</a>
                                </div>
                            </div>
                        </div>
                        <!-- /.box -->
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2016 <a href="http://www.facebook.com/bimaresetu16">Bima Afdani</a>.</strong> All rights reserved. </footer>
