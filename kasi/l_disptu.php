   ...
   <section>   
    <div class="row">
		...
		<div class="content">			
			...
			$unread = mysqli_query($koneksi, "UPDATE t_disp_tu SET baca='Y' WHERE idsurat='$idsurat'");
      ...
      <a href="disp_tu.php" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Kembali</a>
      <a href="cetak.php?idsurat=<?php echo $row['idsurat'];?>" class="btn btn-success" target = "_blank"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Cetak</a>
		</div>
	</div>
          </div>
          <!-- /.box -->
