<?php 
@session_start();
if (@$_SESSION['Kasi PENDIS'] || (@$_SESSION['Kasi BIMAS'])|| (@$_SESSION['Kasi PHU'])|| (@$_SESSION['Kasi P_Syariah'])|| (@$_SESSION['Analis Kepegawaian'])|| (@$_SESSION['Pengawas Pendidikan']) || (@$_SESSION['Bagian Keuangan'])) {
?> 
...
<br/><br/></br>
      <div class="col-sm-2" style="padding:0px; height:595px; background-color:#006400; color:#fff;"> </br> <center> <img src="../image/kmg.jpg" height="110px" width="115px"></br> Anda Login Sebagai :</br> 
      <?php 
      if (@($_SESSION['Kasi PENDIS'])){
       echo "Kasi PENDIS";}
      else if (@($_SESSION['Kasi BIMAS'])){
       echo "Kasi BIMAS";}
      else if (@($_SESSION['Kasi PHU'])){
       echo "Kasi PHU";}
      else if (@($_SESSION['Kasi P_Syariah'])){
       echo "Penyelenggara Syariah";}      
      else if (@($_SESSION['Analis Kepegawaian'])){
       echo "Analis Kepegawaian";}
       else if (@($_SESSION['Pengawas Pendidikan'])){
       echo "Pengawas Pendidikan";}
       else if (@($_SESSION['Bagian Keuangan'])){
