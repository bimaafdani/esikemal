   ...
   <section class="col-lg-12 connectedSortable">
    ...
    <div class="box box-primary">
      ...
      <form class="form-horizontal" method="post">
        ...
        <br>
          <label class="col-sm-5 control-label">Masukkan Nomor Agenda</label>
          <div class="col-sm-5"> <input type="text" name="nama" class="form-control" placeholder="e.g 1xx"> 
          </div>
          <div class="col-md-0">
            <button type="submit" name="lacak" class="btn btn-info" data-toggle="modal"><b>Cari</b> <span class="glyphicon glyphicon-search"></span></button>
      ...
      <br>
      Belum bisa diguanakan, masih dalam tahap pembuatan :D   
  </div>
