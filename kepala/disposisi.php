    ...
    <!-- Isi Tabel atau content-->
     <section class="col-lg-12 connectedSortable">
      ...
      if(isset($_POST['save'])){
        ...
        $update = mysqli_query($koneksi, "UPDATE t_kepala SET  isi_disposisi='$isi_disposisi', petunjuk='$petunjuk', penerima='$banyak' WHERE idsurat='$idsurat'") or die(mysqli_error());
        if($update){
          echo '<script>swal({
                        title:"Surat Telah Di Disposisikan!",
                        type: "success",
                        timer: 1500,
                        showConfirmButton: false
                        }); 
                        setTimeout(function(){location.href="addsurat.php"} , 2000);
                        </script>';
      ...
      <form class="form-horizontal" action="" method="post">
        <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <input type="checkbox" name="penerima[]" value="Kasubbag TU"> Kasubbag TU</br>
            <input type="checkbox" name="penerima[]" value="Kasi PENDIS"> Kasi PENDIS</br>
            <input type="checkbox" name="penerima[]" value="Kasi BIMAS"> Kasi BIMAS </br>
            <input type="checkbox" name="penerima[]" value="Kasi PHU"> Kasi PHU</br>
            <input type="checkbox" name="penerima[]" value="Penyelenggara Syariah"> Penyelenggara Syari'ah</br>
            </fieldset>
          </div>
        </div>
        ...
        <div class="form-group">
          <label class="col-sm-3 control-label">Catatan Kepala</label></br>
          <div class="col-sm-4">
            <textarea name="isi_disposisi" class="form-control">
            </textarea>
        </div>
        </div>
