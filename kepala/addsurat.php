          ...
          <div class="box">
            ...
            <table class="table table-bordered">
              ...
              <?php
                 ...
                 $sql = mysqli_query($koneksi, "SELECT * FROM t_kepala ORDER BY idsurat DESC");
              ...
              <?php
                     ...
                     <tr>
                        ...
                        <td><b>'.$row['perihal'].'</td>
                        <td><b>'.$row['asal'].'</td>               
                        <td><b><center><a href="../surat_masuk/'.$row['file'].'"target = "_blank">File</td>
                        <td><b><center>
                        <a href="l_suratmasuk.php?idsurat='.$row['idsurat'].'" title="Lihat Detail">Detail</span></a>
                      </td>  
                    </tr>
                    ';}
                    else {
